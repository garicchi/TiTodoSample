...
// in simulator we redefine to format for TiTodoSample Developer console
...
{\
	NSString * exceptionName = [@"org.titodosample." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titodosample";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITiTodoSampleNativeItemNone = -1, 
	UITiTodoSampleNativeItemSpinner = -2,
	UITiTodoSampleNativeItemProgressBar = -3,
	
	UITiTodoSampleNativeItemSlider = -4,
	UITiTodoSampleNativeItemSwitch = -5,
	UITiTodoSampleNativeItemMultiButton = -6,
	UITiTodoSampleNativeItemSegmented = -7,
	
	UITiTodoSampleNativeItemTextView = -8,
	UITiTodoSampleNativeItemTextField = -9,
	UITiTodoSampleNativeItemSearchBar = -10,
	
	UITiTodoSampleNativeItemPicker = -11,
	UITiTodoSampleNativeItemDatePicker = -12,
	
	UITiTodoSampleNativeItemInfoLight = -13,
	UITiTodoSampleNativeItemInfoDark = -14,
	
	UITiTodoSampleNativeItemDisclosure = -15,
	
	UITiTodoSampleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiTodoSample instances of
